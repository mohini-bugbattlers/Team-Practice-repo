...
const navigation = [
  ...
  { name: "All Trips", href: "/trips", icon: Truck },
    ...
    <div className="hidden md:flex md:w-64 md:flex-col md:fixed md:inset-y-0 z-50">
      <div className="flex flex-col flex-grow pt-5 bg-white overflow-y-auto border-r border-gray-100 shadow-soft">
        <div className="flex items-center flex-shrink-0 px-6 mb-6">
          ...
          <div>
            <h2 className="text-lg font-bold text-dark-800">Manager Panel</h2>
            <p className="text-xs text-dark-500">Transport Operations</p>
          </div>
        </div>
