  ...
  return (
    <div className="flex h-screen bg-gray-50">
      ...
      <div
        ...
        } lg:translate-x-0 transition-transform duration-200 ease-in-out z-30 w-64 bg-white border-r border-gray-200 overflow-y-auto`}
      >
        ...
        <div className="p-4">
          ...
          <nav className="space-y-1">
            ...
            <NavItem
              ...
              icon={FiTruck}
              label="My Trips"
              active={pathname === "/driver/trips"}
            />
            <NavItem
              href="/driver/live-tracking"
              icon={FiMap}
              label="Live Tracking"
              active={pathname === "/driver/live-tracking"}
            />
            <NavItem
        ...
        <footer className="bg-white border-t border-gray-200 py-4 px-6">
          <div className="container mx-auto flex flex-col md:flex-row justify-between items-center">
            <p className="text-sm text-gray-600">
              © {new Date().getFullYear()} Prathmesh Roadlines. All rights
              reserved.
            </p>
