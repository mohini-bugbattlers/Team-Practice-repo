    ...
    const mockNotifications: Notification[] = [
      {
        id: 1,
        title: "Trip Update",
        message: "Your trip TR-001 has been approved and assigned to a driver",
        type: "success",
      ...
      },
      {
        ...
        message: "Payment of ₹27,500 has been received for completed trip",
        type: "success",
              ...
              <div className="max-w-lg w-full lg:max-w-xs">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    placeholder="Search trips, invoices..."
                    type="search"
                  />
                </div>
              </div>
            ...
            <div className="ml-3 relative" ref={profileRef}>
              <div className="flex items-center">
                ...
                <div className="ml-3 hidden md:block">
                  <p className="text-sm font-medium text-dark-800">{user?.name || 'Company User'}</p>
                  <p className="text-xs text-dark-500">{user?.email || 'user@company.com'}</p>
                </div>
              </div>
              ...
              {dropdownOpen && (
                <div className="absolute right-0 mt-2 w-48 bg-white rounded-xl shadow-large border border-gray-100 z-50">
                  <div className="p-4 border-b border-gray-100">
                    <p className="text-sm font-medium text-dark-900">{user?.name || 'Company User'}</p>
                    <p className="text-xs text-dark-500">{user?.email || 'user@company.com'}</p>
                  </div>
                  <div className="py-1">
                    <button
